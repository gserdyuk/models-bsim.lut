...
#define BSIM3NSRCS        5  /* the number of BSIM3 MOSFET noise sources */
    ...
    LUT3D_rr * lutptr;
    int lut_inited;
    int BSIM3lut_mode; /* 0 - no LUT, 1- NOCAP, 2 - full LUT*/
    unsigned BSIM3lut_modeGiven :1;
#endif /* LUT */
...
/* Pre-calculated constants */
    ...
    double BSIM3vbsmax;
    int    BSIM3vbsnum;
    unsigned BSIM3vgsminGiven   :1;
    unsigned BSIM3vgsmaxGiven   :1;
    unsigned BSIM3vgsnumGiven   :1;
    unsigned BSIM3vdsminGiven   :1;
    unsigned BSIM3vdsmaxGiven   :1;
    unsigned BSIM3vdsnumGiven   :1;
    unsigned BSIM3vbsminGiven   :1;
    unsigned BSIM3vbsmaxGiven   :1;
    unsigned BSIM3vbsnumGiven   :1;
#endif /* LUT */
...
#ifdef LUT  /* LUT implementation */
#define BSIM3_VGSMIN                801
#define BSIM3_VGSMAX                802
#define BSIM3_VGSNUM                803
#define BSIM3_VDSMIN                804
#define BSIM3_VDSMAX                805
#define BSIM3_VDSNUM                806
#define BSIM3_VBSMIN                807
#define BSIM3_VBSMAX                808
#define BSIM3_VBSNUM                809
#endif
