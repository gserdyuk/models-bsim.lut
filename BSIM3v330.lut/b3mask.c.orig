...
static char rcsid[] = "$Id: b3mask.c, v3.3.0 07/29/2005 18:00:00 Xuemei Xi Release $";
...
#ifdef LUT
        case BSIM3_VGSMIN:
            value->rValue = model->BSIM3vgsmin;
            return(OK);
        case BSIM3_VGSMAX:
            value->rValue = model->BSIM3vgsmax;
            return(OK);
        case BSIM3_VGSNUM:
            value->rValue = model->BSIM3vgsnum;
            return(OK);
        case BSIM3_VDSMIN:
            value->rValue = model->BSIM3vdsmin;
            return(OK);
        case BSIM3_VDSMAX:
            value->rValue = model->BSIM3vdsmax;
            return(OK);
        case BSIM3_VDSNUM:
            value->rValue = model->BSIM3vdsnum;
            return(OK);
        case BSIM3_VBSMIN:
            value->rValue = model->BSIM3vbsmin;
            return(OK);
        case BSIM3_VBSMAX:
            value->rValue = model->BSIM3vbsmax;
            return(OK);
        case BSIM3_VBSNUM:
            value->rValue = model->BSIM3vbsnum;
            return(OK);
#endif
        default:
            return(E_BADPARM);
