...
static char rcsid[] = "$Id: b3mpar.c, v3.3.0 07/29/2005 18:00:00 Xuemei Xi Release $";
...
#ifdef LUT
        case  BSIM3_VGSMIN :
            mod->BSIM3vgsmin = value->rValue;
            mod->BSIM3vgsminGiven = TRUE;
            break;
        case  BSIM3_VGSMAX :
            ...
            break;
        case  BSIM3_VGSNUM :
            mod->BSIM3vgsnum = value->iValue;
            mod->BSIM3vgsnumGiven = TRUE;
            break;
        case  BSIM3_VDSMIN :
            mod->BSIM3vdsmin = value->rValue;
            mod->BSIM3vdsminGiven = TRUE;
            break;
        case  BSIM3_VDSMAX :
            ...
            break;
        case  BSIM3_VDSNUM :
            mod->BSIM3vdsnum = value->iValue;
            mod->BSIM3vdsnumGiven = TRUE;
            break;
        case  BSIM3_VBSMIN :
            mod->BSIM3vbsmin = value->rValue;
            mod->BSIM3vbsminGiven = TRUE;
            break;
        case  BSIM3_VBSMAX :
            ...
            break;
        case  BSIM3_VBSNUM :
            mod->BSIM3vbsnum = value->iValue;
            mod->BSIM3vbsnumGiven = TRUE;
            break;
#endif
        default:
            return(E_BADPARM);
