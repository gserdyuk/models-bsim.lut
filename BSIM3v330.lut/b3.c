...
static char rcsid[] = "$Id: b3.c, v3.3.0 beta 07/29/2005 18:00:00 Xuemei Xi Release $";
...
#ifdef LUT
IOP( "lut_mode", BSIM3_LUT_MODE,      IF_INTEGER, "LUT mode (0,1,2) "),
#endif
};
...
#ifdef LUT
IOP( "vgsmin", BSIM3_VGSMIN, IF_REAL,   "min value of grid along vgs"),
IOP( "vgsmax", BSIM3_VGSMAX, IF_REAL,   "max value of grid along vgs"),
IOP( "vgsnum", BSIM3_VGSNUM, IF_INTEGER,"number of lines of grid along vgs"),
IOP( "vdsmin", BSIM3_VDSMIN, IF_REAL,   "min value of grid along vds"),
IOP( "vdsmax", BSIM3_VDSMAX, IF_REAL,   "max value of grid along vds"),
IOP( "vdsnum", BSIM3_VDSNUM, IF_INTEGER,"number of lines of grid along vds"),
IOP( "vbsmin", BSIM3_VBSMIN, IF_REAL,   "min value of grid along vbs"),
IOP( "vbsmax", BSIM3_VBSMAX, IF_REAL,   "max value of grid along vbs"),
IOP( "vbsnum", BSIM3_VBSNUM, IF_INTEGER,"number of lines of grid along vbs"),
#endif
};
